...
from DAMS.apps.generic_views.views import generic_assign_remove, \
                                generic_delete, \
                                generic_detail, generic_list

from DAMS.apps.photos.views import generic_photos
...
urlpatterns = patterns('inventory.views',
    ...
    url(r'^template/create/$', CreateView, {'form_class':ItemTemplateForm, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'item template')}}, 'template_create'),
    url(r'^template/(?P<object_id>\d+)/update/$', UpdateView, {'form_class':ItemTemplateForm, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'item template')}}, 'template_update' ),
    ...
    url(r'^inventory/create/$', CreateView, {'model':Inventory, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'inventory')}}, 'inventory_create'),
    url(r'^inventory/(?P<object_id>\d+)/$', 'inventory_view', (),'inventory_view'),
    url(r'^inventory/(?P<object_id>\d+)/update/$', UpdateView, {'form_class':InventoryForm, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'inventory')}}, 'inventory_update'),
    ...
    url(r'^transaction/create/$', UpdateView, {'model':InventoryTransaction, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'transaction')}}, 'inventory_transaction_create'),
    ...
    url(r'^transaction/(?P<object_id>\d+)/update/$', UpdateView, {'model':InventoryTransaction, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'transaction')}}, 'inventory_transaction_update'),
    ...
    url(r'^location/create/$', CreateView, {'model':Location, 'template_name':'generic_form.html'}, 'location_create'),
    url(r'^location/(?P<object_id>\d+)/update/$', UpdateView, {'model':Location, 'template_name':'generic_form.html'}, 'location_update'),
    ...
    url(r'^supplier/create/$', CreateView, {'form_class':SupplierForm, 'template_name':'generic_form.html'}, 'supplier_create'),
    url(r'^supplier/(?P<object_id>\d+)/update/$', UpdateView, {'form_class':SupplierForm, 'template_name':'generic_form.html'}, 'supplier_update'),
