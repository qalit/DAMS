...
from DAMS.apps.inventory import location_filter
...
urlpatterns = patterns('assets.views',
    ...
    url(r'^person/create/$', CreateView, {'form_class':PersonForm, 'template_name':'generic_form.html'}, 'person_create'),
    url(r'^person/(?P<object_id>\d+)/update/$', UpdateView, {'form_class':PersonForm, 'template_name':'generic_form.html'}, 'person_update'),
    ...
    url(r'^asset/create/$', CreateView, {'form_class':ItemForm, 'template_name':'generic_form.html'}, 'item_create'),
    url(r'^asset/(?P<object_id>\d+)/update/$', UpdateView, {'form_class':ItemForm, 'template_name':'generic_form.html', 'extra_context':{'object_name':_(u'asset')}}, 'item_update'),
    ...
    url(r'^group/create/$', CreateView, {'form_class':ItemGroupForm, 'template_name':'generic_form.html'}, 'group_create'),
    ...
    url(r'^state/create/$', CreateView, {'model':State, 'template_name':'generic_form.html', 'extra_context':{'title':'create asset state'}}, 'state_create'),
    url(r'^state/(?P<object_id>\d+)/update/$', UpdateView, {'model':State, 'template_name':'generic_form.html'}, 'state_update'),
