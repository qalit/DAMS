...
from DAMS.apps.photos.models import GenericPhoto

from DAMS.apps.dynamic_search.api import register
from DAMS.apps.inventory.models import ItemTemplate, Location
